...
## Current snapshot (2026-09-09 02:10 UTC)

| Metric | Value |
|--------|------:|
| Newdrop merges (7d) | 20 |
| Non-noop cycles/day | 7 today · proj 77.2/day · week_avg 8.0 (bar ≥8) [GAP] |
| Free-desktop agent cap | 8 |
| Theater Active share | 0% (0/6 open) |
| Brain / daemons | CLEAN peer-loop=active improve-loop=active ssh_rc=0 |

Merges: #270 fix(embed): Soft Soft tip-stamp Hard-Fix #89 widget partitio (https://github.com/heyitsmeyourbudlol-lgtm/caas-changelog/pull/270); #269 Soft Soft tip-stamp Hard-Fix #77 AI draft shared cost (https://github.com/heyitsmeyourbudlol-lgtm/caas-changelog/pull/269); #268 fix(auth): Soft Soft tip-stamp Hard-Fix #25 custom Auth doma (https://github.com/heyitsmeyourbudlol-lgtm/caas-changelog/pull/268); #267 Fail-closed: HTTPS-only support embed + CSP cite SoT (https://github.com/heyitsmeyourbudlol-lgtm/caas-changelog/pull/267); #266 Soft Soft tip-stamp #100 session revoke-all residual (https://github.com/heyitsmeyourbudlol-lgtm/caas-changelog/pull/266)
